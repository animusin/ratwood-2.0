...
/mob/dead/observer/Destroy()
	// These are /image, not qdel-able datums - qdel() trips the CRASH() in /image/Destroy.
	// Dropping the references (after pulling them from the GLOB lists) is enough for them to be freed.
